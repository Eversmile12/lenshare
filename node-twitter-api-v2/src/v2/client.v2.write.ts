...
import type { CreateDMConversationParams, PostDMInConversationParams, PostDMInConversationResult } from '../types/v2/dm.v2.types';
...
export default class TwitterApiv2ReadWrite extends TwitterApiv2ReadOnly {
  ...
  declare protected _labs?: TwitterApiv2LabsReadWrite;
